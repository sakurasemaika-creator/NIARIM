      ...
      builder: (ctx) => AlertDialog(
        ...
        content: SingleChildScrollView(
          child: Column(
            ...
            crossAxisAlignment: CrossAxisAlignment.start,
            children: [
              Text(l10n.canvasHelpRotationTitle, style: const TextStyle(fontWeight: FontWeight.bold, fontFamily: 'Kuramubon')),
              Text(l10n.canvasHelpRotationBody),
              const SizedBox(height: 8),
              Text(l10n.canvasHelpTatechuyokoTitle, style: const TextStyle(fontWeight: FontWeight.bold, fontFamily: 'Kuramubon')),
              Text(l10n.canvasHelpTatechuyokoBody),
              const SizedBox(height: 8),
              Text(l10n.canvasHelpRubyTitle, style: const TextStyle(fontWeight: FontWeight.bold, fontFamily: 'Kuramubon')),
