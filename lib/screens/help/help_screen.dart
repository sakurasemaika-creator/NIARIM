...
class _HelpScreenState extends State<HelpScreen> {
  ...
  List<_HelpEntry> _buildEntries(AppLocalizations l10n) => [
        ...
        _HelpEntry(topicKey: 'プロジェクト詳細画面', title: l10n.helpProjectDetailTitle, description: l10n.helpProjectDetailDesc, category: l10n.helpCategoryProjectManagement),
        _HelpEntry(topicKey: '描画領域', title: l10n.helpDrawingAreaTitle, description: l10n.helpDrawingAreaDesc, category: l10n.helpCategoryDrawing),
        _HelpEntry(topicKey: 'キャンバスの背景色', title: l10n.helpCanvasBackgroundTitle, description: l10n.helpCanvasBackgroundDesc, category: l10n.helpCategoryDrawing),
