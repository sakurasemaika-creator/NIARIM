...
class _HelpScreenState extends State<HelpScreen> {
  ...
  final List<_HelpEntry> _entries = const [
    ...
    _HelpEntry('フォルダ', 'プロジェクトをグループ化できます。複数階層に対応しているので、'
        '同じ作品の複数話数やシリーズ物をまとめて管理する使い方もできます'
        '（例：「作品名」フォルダの中に「第1話」「第2話」…とプロジェクトを並べる）。'
        '1つの動画の中で場面を分けて作りたい場合は、フォルダではなくキャンバス画面の'
        '「シーン」機能をご利用ください。', 'プロジェクト管理'),
  ];
