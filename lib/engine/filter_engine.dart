...
List<(double, int, int, int)> auroraHologramStops(AuroraHologramPreset preset) {
  return switch (preset) {
    ...
    AuroraHologramPreset.blueHologram => const [
      (0.00, 35, 72, 158),
      (0.09, 80, 145, 255),
      (0.18, 176, 221, 255),
      (0.28, 247, 252, 255),
    ...
    AuroraHologramPreset.moonlightPearl => const [
      (0.00, 112, 105, 128),
      (0.10, 151, 139, 159),
      (0.20, 187, 173, 185),
      (0.30, 211, 203, 191),
    ...
    AuroraHologramPreset.rainbowPearl => const [
      (0.00, 118, 110, 132),
      (0.09, 154, 144, 165),
      (0.18, 184, 170, 187),
      (0.27, 194, 184, 166),
    ...
    AuroraHologramPreset.warmHologram => const [
      (0.00, 91, 18, 58),
      (0.09, 148, 36, 82),
      (0.18, 216, 65, 105),
      (0.27, 255, 103, 123),
