...
class AppLocalizationsEs extends AppLocalizations {
  ...
  String get privacyPolicyArt7Body =>
      '1. Únicamente cuando el usuario, por decisión propia, publica una obra mediante la función «Plaza de Obras» (artículo 12 de los Términos de Uso), el desarrollador gestiona en sus servidores la siguiente información relativa a dicha publicación:\n・Información necesaria para identificar y mostrar la obra publicada (ID del vídeo de YouTube, título, estadísticas, etc.)\n・El ID de usuario de NIARIM emitido para el uso de las funciones de publicación, denuncia y bloqueo (un identificador emitido dentro de la Aplicación, distinto de la cuenta de Google)\n・El contenido de una denuncia, en caso de utilizarse la función de denuncia, y el ID de usuario de NIARIM del denunciante\n2. El archivo de vídeo en sí se almacena en YouTube, no en los servidores del desarrollador.\n3. La información mencionada en los dos párrafos anteriores se utiliza únicamente para los fines de prestación de la Función Comunitaria (mostrar listados de obras, atender denuncias, gestionar los límites de publicación, etc.).\n4. Si el usuario no utiliza la Función Comunitaria, no se produce ningún tratamiento de información conforme a este artículo (de acuerdo con el principio del artículo 2, no se transmite nada a los servidores del desarrollador).';
