...
class AppLocalizationsEn extends AppLocalizations {
  ...
  @override
  String get settingsThemeSubtitle => 'Theme settings, workspace';
  ...
  String get privacyPolicyArt7Body =>
      '1. Only when a user chooses, of their own accord, to post a work using the \"the Work Plaza\" feature (Article 12 of the Terms of Service), the developer manages the following information relating to that post on its servers:\n・Information needed to identify and display the posted work (YouTube video ID, title, statistics, etc.)\n・The NIARIM User ID issued for use of the posting, reporting, and blocking features (an identifier issued within the App, separate from the Google account)\n・The content of any report submitted using the reporting feature, and the reporting user\'s NIARIM User ID\n2. The video file itself is stored on YouTube, not on the developer\'s servers.\n3. The information described in the preceding two paragraphs is used only for the purposes of providing the Community Feature (displaying listings of works, responding to reports, managing posting limits, etc.).\n4. If a user does not use the Community Feature, no handling of information under this Article occurs (in keeping with the principle in Article 2, nothing is transmitted to the developer\'s servers).';
