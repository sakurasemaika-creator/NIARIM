...
class AppLocalizationsZh extends AppLocalizations {
  ...
  String get privacyPolicyArt7Body =>
      '1. 仅当用户自行选择使用「作品广场」功能（利用条款第12条）发布作品时，开发者才会在服务器上管理与该发布相关的以下信息：\n・用于识别、显示已发布作品所需的信息（YouTube视频ID、标题、统计信息等）\n・用户使用发布、举报、屏蔽功能时颁发的NIARIM User ID（与Google账号不同、由本应用内部颁发的识别码）\n・使用举报功能时的举报内容及举报者的NIARIM User ID\n2. 视频文件本身保存在YouTube上，不会保存在开发者的服务器上。\n3. 前两项所述信息，仅在提供本社区功能（作品列表显示、举报处理、发布上限管理等）目的范围内使用。\n4. 若用户不使用本社区功能，则不会发生本条所述的信息处理（按照第2条的原则，不会向开发者服务器发送任何信息）。';
...
class AppLocalizationsZhHant extends AppLocalizationsZh {
  ...
  @override
  String get privacyPolicyArt7Body =>
      '1. 僅於使用者自行選擇利用「作品廣場」功能（利用條款第12條）發布作品時，開發者始於伺服器管理與該發布相關之下列資訊：\n・用於識別、顯示已發布作品所需之資訊（YouTube影片ID、標題、統計資訊等）\n・使用者利用發布、檢舉、封鎖功能時核發之NIARIM User ID（與Google帳號不同、由本應用程式內部核發之識別碼）\n・使用檢舉功能時之檢舉內容及檢舉者之NIARIM User ID\n2. 影片檔案本身保存於YouTube上，不會保存於開發者之伺服器上。\n3. 前二項所述資訊，僅於提供本社群功能（作品列表顯示、檢舉處理、發布上限管理等）之目的範圍內使用。\n4. 若使用者未使用本社群功能，則不會發生本條所定之資訊處理（依第2條之原則，不會向開發者伺服器傳送任何資訊）。';
