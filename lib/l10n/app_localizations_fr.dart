...
class AppLocalizationsFr extends AppLocalizations {
  ...
  String get privacyPolicyArt7Body =>
      '1. Uniquement lorsque l\'utilisateur choisit, de sa propre initiative, de publier une œuvre au moyen de la fonction « Place des œuvres » (article 12 des Conditions d\'utilisation), le développeur gère sur ses serveurs les informations suivantes relatives à cette publication :\n・Les informations nécessaires à l\'identification et à l\'affichage de l\'œuvre publiée (identifiant de la vidéo YouTube, titre, statistiques, etc.)\n・L\'identifiant utilisateur NIARIM délivré lors de l\'utilisation des fonctions de publication, de signalement et de blocage (un identifiant délivré au sein de l\'Application, distinct du compte Google)\n・Le contenu d\'un signalement, en cas d\'utilisation de la fonction de signalement, ainsi que l\'identifiant utilisateur NIARIM de la personne ayant signalé\n2. Le fichier vidéo lui-même est stocké sur YouTube, et non sur les serveurs du développeur.\n3. Les informations mentionnées aux deux paragraphes précédents ne sont utilisées que dans le cadre de la fourniture de la Fonction Communautaire (affichage des listes d\'œuvres, traitement des signalements, gestion des limites de publication, etc.).\n4. Si l\'utilisateur n\'utilise pas la Fonction Communautaire, aucun traitement d\'information au titre du présent article n\'a lieu (conformément au principe de l\'article 2, rien n\'est transmis aux serveurs du développeur).';
