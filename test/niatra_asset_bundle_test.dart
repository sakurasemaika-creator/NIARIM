...
void main() {
  ...
  test('niatra embeds custom brush tone and stamp images with full model json', () async {
    SharedPreferences.setMockInitialValues({});
    final temp = await Directory.systemTemp.createTemp('niatra_asset_bundle_test_');
    addTearDown(() async {
    ...
    toneService.addTone(Tone(
      id: 'custom-tone',
      name: 'tone',
      texturePath: toneImage,
    ));
    ...
    final baseData = utf8.encode(jsonEncode({'appVersion': '1.0.0', 'keep': 42}));
    ...
    final brushJson = (data['brushes'] as List).single as Map<String, dynamic>;
    ...
    expect((brushJson['fadeCustom'] as Map<String, dynamic>)['distancePx'], 240);
