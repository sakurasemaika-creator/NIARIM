...
void main() {
  ...
  test('settings numeric, workspace and first-launch values persist with clamping', () async {
  ...
  test('toolbar, docks, all gesture actions and pressure curves round-trip', () async {
    final s = SettingsService();
    await s.init();
  ...
  test('custom canvas size presets add update duplicate reorder and remove persist', () async {
    ...
    await s.updateCustomSizePreset(firstId, name: 'A2', width: 111, height: 222);
