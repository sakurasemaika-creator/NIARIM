...
void main() {
  ...
  group('QuickToolService direct coverage', () {
    ...
    test(
      'default entries cycle, add/remove/reorder and persistence work',
      () async {
  ...
  group('FirstUseTooltipService direct coverage', () {
    ...
    test(
      'markSeen persists, duplicate mark is idempotent, reset clears',
      () async {
        ...
        expect(
          notifications,
          1,
          reason: 'duplicate mark must not notify again',
        );
